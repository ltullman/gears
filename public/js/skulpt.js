var skulpt = new function() {
  ...
  this.externalLibs = {
    ...
    './spike/patch.py': 'spike/patch.py?v=23892083',
    './spike/__init__.py': 'spike/__init__.py?v=23892083',
    './spike/control.py': 'spike/control.py?v=bba8d7d8', 
    './spike/operator.py': 'spike/operator.py?v=bba8d7d8', 
